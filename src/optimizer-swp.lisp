...
(define-inst-type-predicate %opt-swp-loop-cmp-p (or vm-lt vm-le vm-gt vm-ge vm-eq vm-num-eq) "Return T when INST is a comparison supported by software pipelining.")
